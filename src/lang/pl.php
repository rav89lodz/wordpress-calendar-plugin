...
return [
    ...
    'optionPage' => [
        ...
        'main_menu_field16_description' => 'Podaj wartość dla szerokości siatki kalendarza w px, zgodnie ze standardami CSS, np. 1200px. Zostaw puste jeśli chcesz korzystać z wartości domyślnej: 1200px',
        'main_menu_field17_name' => 'Ustaw wysokość siatki kalendarza w px',
        'main_menu_field17_description' => 'Podaj wartość dla wysokości siatki kalendarza w px, zgodnie ze standardami CSS, np. 800px. Zostaw puste jeśli chcesz korzystać z wartości domyślnej: 100%',
